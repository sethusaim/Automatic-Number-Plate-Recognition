...
_LOSS_EXPECTEDLOSSWEIGHTS = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="REWEIGHTING_UNMATCHED_ANCHORS",
            index=2,
            number=2,
            serialized_options=None,
            type=None,
...
_HARDEXAMPLEMINER_LOSSTYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="BOTH", index=0, number=0, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="CLASSIFICATION", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="LOCALIZATION", index=2, number=2, serialized_options=None, type=None
        ),
    ],
    containing_type=None,
    serialized_options=None,
...
_LOSS = _descriptor.Descriptor(
    ...
    enum_types=[_LOSS_EXPECTEDLOSSWEIGHTS,],
    serialized_options=None,
    is_extendable=False,
    syntax="proto2",
    extension_ranges=[],
...
_HARDEXAMPLEMINER = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[],
    enum_types=[_HARDEXAMPLEMINER_LOSSTYPE,],
    serialized_options=None,
    is_extendable=False,
    syntax="proto2",
    extension_ranges=[],
...
].message_type = _WEIGHTEDSOFTMAXCLASSIFICATIONAGAINSTLOGITSLOSS
_CLASSIFICATIONLOSS.fields_by_name[
...
Loss = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        "EqualizationLoss": _reflection.GeneratedProtocolMessageType(
            "EqualizationLoss",
            (_message.Message,),
            {
...
WeightedSoftmaxClassificationAgainstLogitsLoss = _reflection.GeneratedProtocolMessageType(
    "WeightedSoftmaxClassificationAgainstLogitsLoss",
    (_message.Message,),
    {
...
RandomExampleSampler = _reflection.GeneratedProtocolMessageType(
