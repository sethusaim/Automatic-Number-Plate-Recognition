...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        object__detection_dot_protos_dot_faster__rcnn__pb2.DESCRIPTOR,
        object__detection_dot_protos_dot_ssd__pb2.DESCRIPTOR,
    ],
)
...
_DETECTIONMODEL.fields_by_name[
    "faster_rcnn"
].message_type = object__detection_dot_protos_dot_faster__rcnn__pb2._FASTERRCNN
_DETECTIONMODEL.fields_by_name[
    "ssd"
].message_type = object__detection_dot_protos_dot_ssd__pb2._SSD
...
_DETECTIONMODEL.fields_by_name["ssd"].containing_oneof = _DETECTIONMODEL.oneofs_by_name[
    "model"
]
