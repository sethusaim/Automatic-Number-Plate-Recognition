...
_RESIZETYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="BICUBIC", index=2, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="AREA", index=3, number=3, serialized_options=None, type=None
        ),
    ],
...
_CONDITIONALSHAPERESIZER_RESIZECONDITION = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="GREATER", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="SMALLER", index=2, number=2, serialized_options=None, type=None
        ),
    ],
    containing_type=None,
    serialized_options=None,
...
_IMAGERESIZER = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="conditional_shape_resizer",
...
_CONDITIONALSHAPERESIZER = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[],
    enum_types=[_CONDITIONALSHAPERESIZER_RESIZECONDITION,],
    serialized_options=None,
    is_extendable=False,
    syntax="proto2",
    extension_ranges=[],
...
].message_type = _CONDITIONALSHAPERESIZER
...
_CONDITIONALSHAPERESIZER.fields_by_name[
    "condition"
].enum_type = _CONDITIONALSHAPERESIZER_RESIZECONDITION
...
IdentityResizer = _reflection.GeneratedProtocolMessageType(
    "IdentityResizer",
    (_message.Message,),
    {
...
ConditionalShapeResizer = _reflection.GeneratedProtocolMessageType(
