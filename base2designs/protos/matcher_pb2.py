...
from object_detection.protos import (
    argmax_matcher_pb2 as object__detection_dot_protos_dot_argmax__matcher__pb2,
)
from object_detection.protos import (
    bipartite_matcher_pb2 as object__detection_dot_protos_dot_bipartite__matcher__pb2,
)
...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        object__detection_dot_protos_dot_argmax__matcher__pb2.DESCRIPTOR,
        object__detection_dot_protos_dot_bipartite__matcher__pb2.DESCRIPTOR,
    ],
)
...
_MATCHER.fields_by_name[
    "argmax_matcher"
].message_type = object__detection_dot_protos_dot_argmax__matcher__pb2._ARGMAXMATCHER
_MATCHER.fields_by_name[
    "bipartite_matcher"
].message_type = (
    object__detection_dot_protos_dot_bipartite__matcher__pb2._BIPARTITEMATCHER
)
_MATCHER.oneofs_by_name["matcher_oneof"].fields.append(
    _MATCHER.fields_by_name["argmax_matcher"]
)
_MATCHER.fields_by_name["argmax_matcher"].containing_oneof = _MATCHER.oneofs_by_name[
    "matcher_oneof"
]
_MATCHER.oneofs_by_name["matcher_oneof"].fields.append(
    _MATCHER.fields_by_name["bipartite_matcher"]
)
_MATCHER.fields_by_name["bipartite_matcher"].containing_oneof = _MATCHER.oneofs_by_name[
    "matcher_oneof"
]
