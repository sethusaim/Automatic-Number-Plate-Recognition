...
from object_detection.protos import (
    calibration_pb2 as object__detection_dot_protos_dot_calibration__pb2,
)
...
_POSTPROCESSING_SCORECONVERTER = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="SOFTMAX", index=2, number=2, serialized_options=None, type=None
        ),
    ],
...
_BATCHNONMAXSUPPRESSION = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="max_classes_per_detection",
...
_POSTPROCESSING = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[],
    enum_types=[_POSTPROCESSING_SCORECONVERTER,],
    serialized_options=None,
    is_extendable=False,
    syntax="proto2",
    extension_ranges=[],
...
].message_type = _BATCHNONMAXSUPPRESSION
_POSTPROCESSING.fields_by_name[
    "score_converter"
].enum_type = _POSTPROCESSING_SCORECONVERTER
_POSTPROCESSING.fields_by_name[
    "calibration_config"
].message_type = object__detection_dot_protos_dot_calibration__pb2._CALIBRATIONCONFIG
