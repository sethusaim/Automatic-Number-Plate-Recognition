...
_INSTANCEMASKTYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="PNG_MASKS", index=2, number=2, serialized_options=None, type=None
        ),
    ],
...
_INPUTREADER = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="filenames_shuffle_buffer_size",
...
].message_type = _TFRECORDINPUTREADER
...
_INPUTREADER.fields_by_name[
    "tf_record_input_reader"
].containing_oneof = _INPUTREADER.oneofs_by_name["input_reader"]
_INPUTREADER.oneofs_by_name["input_reader"].fields.append(
