...
class PlateCompare:
    ...
    def calcStats(self):
        platesWithCharCorrect_recall = (
            self.cum_plateWithCharMatchCnt / self.cum_plateCnt_gt
        )
        platesWithCharCorrect_precision = (
            self.cum_plateWithCharMatchCnt / self.cum_plateCnt_pred
        )
