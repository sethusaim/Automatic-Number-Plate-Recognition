...
from base2designs.core import standard_fields as fields
from base2designs.utils import shape_utils
from base2designs.utils import spatial_transform_ops as spatial_ops
from base2designs.utils import static_shape
...
def nearest_neighbor_upsampling(
    input_tensor, scale=None, height_scale=None, width_scale=None
):
