...
class LabelMapUtilTest(tf.test.TestCase):
    ...
    """
        ...
        self.assertListEqual(
            [{"id": 2, "name": u"cat"}, {"id": 1, "name": u"child"}], categories
        )
    ...
    def test_convert_label_map_to_categories_no_label_map(self):
        ...
        expected_categories_list = [
            {"name": u"category_1", "id": 1},
            {"name": u"category_2", "id": 2},
            {"name": u"category_3", "id": 3},
        ]
    ...
    def test_create_category_index(self):
        ...
        self.assertDictEqual(
            {1: {"name": u"1", "id": 1}, 2: {"name": u"2", "id": 2}}, category_index
        )
    ...
    """
        ...
        self.assertListEqual(
            [{"name": u"dog", "id": 1}, {"name": u"cat", "id": 2}], categories
        )
    ...
    """
        ...
        self.assertDictEqual(
            {1: {"name": u"dog", "id": 1}, 2: {"name": u"cat", "id": 2}}, category_index
        )
    ...
    """
        ...
        self.assertDictEqual(
            {1: {"name": u"dog", "id": 1}, 2: {"name": u"cat", "id": 2}},
            label_map_util.create_category_index_from_labelmap(label_map_path, False),
        )

        self.assertDictEqual(
            {1: {"name": u"woof", "id": 1}, 2: {"name": u"meow", "id": 2}},
